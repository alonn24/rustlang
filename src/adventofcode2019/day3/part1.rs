...
pub fn part1(str_wire1: String, str_wire2: String) -> i32 {
  ...
  found.iter().fold(std::i32::MAX, |acc, item| i32::min(acc, item.0.abs() + item.1.abs()))
}
...
mod tests {
  ...
  fn calculate_example1() {
    ...
    assert_eq!(159, part1(wire1, wire2));
  }
  ...
  fn calculate_example2() {
    ...
    assert_eq!(135, part1(wire1, wire2));
  }
}
